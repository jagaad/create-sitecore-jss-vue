		...
		<div v-else>
			...
			<div class="row">
				<fieldset class="form-group col-sm">
					...
					<p class="alert alert-warning">
						Note: By default <em>anonymous</em> contacts will not be shown in
						Experience Profile. If your interactions are not showing up in
						Experience Profile, you may need to
						<a
...
export default {
	...
	methods: {
		...
		submitPageView() {
			trackingApi
				.trackEvent(
					[{ pageId: this.txtPageId, url: this.txtPageUrl }],
					this.trackingApiOptions,
				)
